...
func main() {
	...
	// in golang: it can accept any number of arguments, and also can have more than one return

	// arrays
	// in java: arrays are fixed sized new int[]{1,2,3} or new int[26], we can not print arrays without without Arrays.toString()
	// in golang: it's the same

	var name = getName("Massoud") // my name is Massoud
	...
	// // default value for string array is ""
	var arr [7]string
	arr[0] = "Monday"
	arr[6] = "Sunday"
	arr[4] = "Friday"
